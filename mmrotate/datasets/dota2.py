...
class DOTA2Dataset(CustomDataset):
    ...
    PALETTE = [(165, 42, 42), (189, 183, 107), (0, 255, 0), (255, 0, 0),
               ...
               (255, 255, 0), (147, 116, 116), (0, 0, 255), (139, 139, 139),
               (139, 139, 0), (0, 222, 234)
               ]

    def __init__(self,
                 X_L_file,  # added
                 label_type,  # added:specify label/partial label data
                 load_type,
                 ann_file,
                 pipeline,
                 version='oc',
        ...
        super(DOTA2Dataset, self).__init__(X_L_file, label_type, load_type, ann_file, pipeline, **kwargs)
