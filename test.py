...
def parse_args():
    ...
    parser.add_argument('--checkpoint',
                        default='work_dirs/PU/EXP0/cycle0/epoch_12.pth',
                        help='checkpoint file')
    parser.add_argument(
        '--submission-dir',
        default='work_dirs/PU/EXP0/cycle0/example_Task1',
        help='test config file path')
    parser.add_argument(
        '--work-dir',
...
def main():
    ...
    if args.submission_dir is not None:
        cfg.submission_dir = args.submission_dir
    ...
    if rank == 0:
        ...
        if args.format_only:
            # print("在调用dataset.format_results前，cfg.submission_dir的值为:", cfg.submission_dir)
            dataset.format_results(outputs, cfg.submission_dir, **kwargs)
        if args.eval:
