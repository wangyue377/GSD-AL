    ...
    def __init__(self,
        ...
        if hasattr(self.file_client, 'get_local_path'):
            with self.file_client.get_local_path(self.ann_file) as local_path:
                self.data_infos = self.load_annotations(local_path, self.X_L_file, self.load_type)
        else:
            warnings.warn(
            ...
            self.data_infos = self.load_annotations(self.ann_file, self.X_L_file, self.load_type)
